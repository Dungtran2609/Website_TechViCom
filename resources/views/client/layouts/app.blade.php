            ...
            <div class="modal-body px-4 pb-4">
                ...
                <div id="emailLoginForm">
                    <form method="POST" action="{{ route('login') }}" id="loginForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="password" class="form-control form-control-lg border-2" id="password" name="password" placeholder="Nhập mật khẩu" style="border-radius: 12px; border-color: #e9ecef; background-color: #f8f9fa;" >
                                <button type="button" class="btn position-absolute end-0 top-0 h-100 border-0 bg-transparent" id="togglePassword" style="border-radius: 0 12px 12px 0;">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg w-100 mb-3" id="loginSubmitBtn" style="background: linear-gradient(135deg, #ff6c2f 0%, #ff8c42 100%); border: none; border-radius: 12px; font-weight: 600;">
                            <i class="fas fa-arrow-right me-2"></i>Đăng nhập
                        </button>
                    </form>
                    <div class="text-center mb-3">
                        <button type="button" onclick="showForgotPasswordForm()" class="text-decoration-none text-orange-500 small border-0 bg-transparent">
                    ...
                    <div class="text-center">
                        ...
                        <button type="button" onclick="showRegisterForm()" class="text-decoration-none text-orange-500 small ms-1 border-0 bg-transparent">
                ...
                <div id="registerForm" style="display: none;">
                    <form method="POST" action="{{ route('register') }}" id="registerFormSubmit">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg border-2" id="reg_name" name="name" placeholder="Nhập họ và tên của bạn" style="border-radius: 12px; border-color: #e9ecef; background-color: #f8f9fa;" >
                            <div class="invalid-feedback" id="nameError"></div>
                        </div>
                        <div class="mb-3">
                            <label for="reg_email" class="form-label fw-semibold text-dark">Địa chỉ email</label>
                            <input type="email" class="form-control form-control-lg border-2" id="reg_email" name="email" placeholder="Nhập email của bạn" style="border-radius: 12px; border-color: #e9ecef; background-color: #f8f9fa;" >
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="password" class="form-control form-control-lg border-2" id="reg_password" name="password" placeholder="Tạo mật khẩu mạnh" style="border-radius: 12px; border-color: #e9ecef; background-color: #f8f9fa;" >
                                <button type="button" class="btn position-absolute end-0 top-0 h-100 border-0 bg-transparent" id="toggleRegPassword" style="border-radius: 0 12px 12px 0;">
                                    <i class="fas fa-eye text-muted"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-3">
                            <label for="reg_password_confirmation" class="form-label fw-semibold text-dark">Xác nhận mật khẩu</label>
                            <div class="position-relative">
                                <input type="password" class="form-control form-control-lg border-2" id="reg_password_confirmation" name="password_confirmation" placeholder="Nhập lại mật khẩu" style="border-radius: 12px; border-color: #e9ecef; background-color: #f8f9fa;" >
                                <button type="button" class="btn position-absolute end-0 top-0 h-100 border-0 bg-transparent" id="toggleRegConfirmPassword" style="border-radius: 0 12px 12px 0;">
                                    <i class="fas fa-eye text-muted"></i>
                                </button>
                            </div>
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <label class="form-check-label text-muted" for="reg_terms">
                                Tôi đồng ý với <a href="#" class="text-orange-500 text-decoration-none">điều khoản sử dụng</a> và <a href="#" class="text-orange-500 text-decoration-none">chính sách bảo mật</a>
                            </label>
                            <div class="invalid-feedback" id="termsError">Bạn phải đồng ý với điều khoản sử dụng</div>
                        </div>
                        <button type="submit" class="btn btn-primary btn-lg w-100 mb-3" id="registerSubmitBtn" style="background: linear-gradient(135deg, #ff6c2f 0%, #ff8c42 100%); border: none; border-radius: 12px; font-weight: 600;">
                ...
                <div id="forgotPasswordForm" style="display: none;">
                    <form method="POST" action="{{ route('password.email') }}" id="forgotPasswordFormSubmit">
                        @csrf
                        <div class="mb-3">
                            <label for="forgot_email" class="form-label fw-semibold text-dark">Địa chỉ email</label>
                            <input type="email" class="form-control form-control-lg border-2" id="forgot_email" name="email" placeholder="Nhập email của bạn" style="border-radius: 12px; border-color: #e9ecef; background-color: #f8f9fa;" >
                            <div class="invalid-feedback" id="forgotEmailError"></div>
                        </div>
                        <button type="submit" class="btn btn-primary btn-lg w-100 mb-3" id="forgotPasswordSubmitBtn" style="background: linear-gradient(135deg, #ff6c2f 0%, #ff8c42 100%); border: none; border-radius: 12px; font-weight: 600;">
        ...
        loginForm.addEventListener('submit', function(e) {
            ...
            .catch(error => {
                ...
                if (error.message.startsWith('{')) {
                    ...
                    emailInput.classList.add('is-invalid');
                    document.getElementById('emailError').textContent = 'Có lỗi xảy ra, vui lòng thử lại';
                }
            })
            .finally(() => {
                // Reset button state
                ...
                if (error.message.startsWith('{')) {
                    try {
                        ...
                        if (errors.email) {
                            ...
                            document.getElementById('regEmailError').textContent = errors.email[0];
                        }
                        if (errors.password) {
                            regPasswordInput.classList.add('is-invalid');
                            document.getElementById('regPasswordError').textContent = errors.password[0];
                        }
                        if (errors.password_confirmation) {
                            regConfirmPasswordInput.classList.add('is-invalid');
                            document.getElementById('regPasswordConfirmError').textContent = errors.password_confirmation[0];
                        }
                        if (errors.terms) {
                            regTermsInput.classList.add('is-invalid');
                            document.getElementById('termsError').textContent = errors.terms[0];
                        }
                    } catch (e) {
                        console.error('Error parsing validation errors:', e);
                    }
                    ...
                    // Show generic error in form
                    regEmailInput.classList.add('is-invalid');
                    document.getElementById('regEmailError').textContent = 'Có lỗi xảy ra, vui lòng thử lại';
                }
            })
            .finally(() => {
                // Reset button state
            ...
            .catch(error => {
                ...
                if (error.message.startsWith('{')) {
                    try {
                        ...
                        if (errors.email) {
                            forgotEmailInput.classList.add('is-invalid');
                            document.getElementById('forgotEmailError').textContent = errors.email[0];
                        }
                    } catch (e) {
                        console.error('Error parsing validation errors:', e);
                    }
                    ...
                    // Show generic error in form
                    forgotEmailInput.classList.add('is-invalid');
                    document.getElementById('forgotEmailError').textContent = 'Có lỗi xảy ra, vui lòng thử lại';
                }
            })
            .finally(() => {
                // Reset button state
