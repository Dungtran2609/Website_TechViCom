// Check and render Conversion chart
...
// Check and render Performance chart
            ...
            y: [
                {
                    formatter: function (y) {
                        return (typeof y !== "undefined") ? y.toFixed(1) + "k" : y;
                    },
                },
                {
                    formatter: function (y) {
...
// Check and render Vector Map
class VectorMap {
    initWorldMapMarker() {
        const el = document.querySelector('#world-map-markers');
        if (!el) return;
