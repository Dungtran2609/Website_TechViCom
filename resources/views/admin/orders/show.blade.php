            ...
            <div class="card-body">
                                ...
                                <tr>
                                    <td>
                                        @if($item['image_product'])
                                            <img src="{{ $item['image_product'] }}" alt="" class="rounded" width="60">
                                        @else
                ...
                <div class="mt-4">
                    @if($orderData['status'] === 'pending')
                        <form action="{{ route('admin.order.updateOrders', $orderData['id']) }}" method="POST" class="d-inline"
                    ...
                    @endif
                    <a href="{{ route('admin.order.edit', $orderData['id']) }}" class="btn btn-primary ms-2">Sửa</a>
                    <form action="{{ route('admin.order.destroy', $orderData['id']) }}" method="POST" class="d-inline ms-2"
