    ...
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                Mạng lưới đại lý ủy quyền chính thức của Techvicom trên toàn quốc. 
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">Hệ thống logistics hiện đại, giao hàng toàn quốc</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-8 mb-12 text-white">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div class="text-center">
                        ...
                        <p class="text-green-100">Đại lý trên toàn quốc</p>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl font-bold mb-2">63</div>
                        <p class="text-green-100">Tỉnh thành phủ sóng</p>
                    </div>
                    <div class="text-center">
