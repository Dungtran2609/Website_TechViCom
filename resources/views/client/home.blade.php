                            ...
                            @if($category->children->count() > 0)
                                <div class="category-dropdown-wrapper">
                                    ...
                                    <button class="text-xs text-gray-500 hover:text-gray-700 flex items-center mx-auto"
                                        ...
                                        <i class="fas fa-chevron-down ml-1 transition-transform duration-200" id="icon-{{ $category->id }}"></i>
                                    </button>
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between mb-8">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('products.index') }}" class="text-[#ff6c2f] hover:hover:text-[#ff6c2f] font-semibold flex items-center">
                        Xem tất cả <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                    <div class="flex items-center space-x-2 text-lg font-semibold">
                        <span>Kết thúc trong:</span>
                        <div class="bg-[#ff6c2f] text-white px-3 py-1 rounded min-w-[3rem] text-center" id="hours">12</div>
                        <span>:</span>
                        <div class="bg-[#ff6c2f] text-white px-3 py-1 rounded min-w-[3rem] text-center" id="minutes">34</div>
                        <span>:</span>
                        <div class="bg-[#ff6c2f] text-white px-3 py-1 rounded min-w-[3rem] text-center" id="seconds">56</div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" id="flash-sale-products">
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer group" 
                     data-product-id="1"
                     onclick="window.location.href='{{ route('products.show', 1) }}'">
                    <div class="relative">
                        <img src="assets/images/placeholder.svg" alt="iPhone 15 Pro Max" class="w-full h-48 object-cover rounded-t-lg">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button onclick="event.stopPropagation(); addToCartStatic(1, 'iPhone 15 Pro Max 256GB', 34990000, 'assets/images/placeholder.svg')" class="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition">
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer group" data-product-id="2">
                    <div class="relative">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button onclick="addToCartStatic(2, 'Samsung Galaxy S24 Ultra 512GB', 33990000, 'assets/images/samsung-s24-ultra.jpg')" class="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition">
                                <i class="fas fa-cart-plus"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer group" data-product-id="3">
                    <div class="relative">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button onclick="addToCartStatic(3, 'MacBook Pro M3 14inch 512GB', 53990000, 'assets/images/macbook-pro-m3.jpg')" class="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition">
                                <i class="fas fa-cart-plus"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer group" data-product-id="4">
                    <div class="relative">
                        <img src="assets/images/ipad-pro-m2.jpg" alt="iPad Pro M2" class="w-full h-48 object-cover rounded-t-lg">
                        <div class="absolute top-2 left-2 bg-[#ff6c2f] text-white px-2 py-1 rounded text-sm font-bold">
                            -12%
                        </div>
                        <div class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button onclick="addToCartStatic(4, 'iPad Pro M2 11inch 256GB', 24990000, 'assets/images/ipad-pro-m2.jpg')" class="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition">
                                <i class="fas fa-cart-plus"></i>
                            </button>
                        </div>
                    </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer group"
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button onclick="event.stopPropagation(); addToCart({{ $product->id }}, null, 1)" class="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition">
                                    <i class="fas fa-cart-plus"></i>
                                </button>
                            </div>
                        </div>
                ...
                @if($latestProducts->count() < 8)
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer group" data-product-id="5">
                        <div class="relative">
                            <img src="{{ asset('client_css/images/placeholder.svg') }}" alt="AirPods Pro 2" class="w-full h-48 object-cover rounded-t-lg">
                            <div class="absolute top-2 left-2 bg-green-600 text-white px-2 py-1 rounded text-sm font-bold">
                                HOT
                            </div>
                            <div class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button onclick="addToCartStatic(5, 'AirPods Pro 2nd Gen', 6990000, '{{ asset('client_css/images/placeholder.svg') }}')" class="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition">
                                    <i class="fas fa-cart-plus"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer group" data-product-id="6">
                        <div class="relative">
                            <img src="{{ asset('client_css/images/placeholder.svg') }}" alt="Apple Watch Series 9" class="w-full h-48 object-cover rounded-t-lg">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button onclick="addToCartStatic(6, 'Apple Watch Series 9 GPS 45mm', 10990000, '{{ asset('client_css/images/placeholder.svg') }}')" class="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition">
                                    <i class="fas fa-cart-plus"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer group" data-product-id="7">
                        <div class="relative">
                            <img src="{{ asset('client_css/images/placeholder.svg') }}" alt="Sony WH-1000XM5" class="w-full h-48 object-cover rounded-t-lg">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button onclick="addToCartStatic(7, 'Sony WH-1000XM5 Wireless', 8490000, '{{ asset('client_css/images/placeholder.svg') }}')" class="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition">
                                    <i class="fas fa-cart-plus"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer group" data-product-id="8">
                        <div class="relative">
                            <img src="{{ asset('client_css/images/placeholder.svg') }}" alt="Samsung Galaxy Buds2" class="w-full h-48 object-cover rounded-t-lg">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button onclick="addToCartStatic(8, 'Samsung Galaxy Buds2 Pro', 3990000, '{{ asset('client_css/images/placeholder.svg') }}')" class="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition">
                                    <i class="fas fa-cart-plus"></i>
                                </button>
                            </div>
                        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function closeAllDropdowns() {
            const dropdowns = document.querySelectorAll('.account-dropdown, .category-dropdown, .cart-dropdown');
