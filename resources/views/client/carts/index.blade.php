                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-white rounded-lg shadow-md p-6 sticky top-6">
                                ...
                                <button onclick="proceedToCheckout()"
                                    ...
                                    id="checkout-all-btn" type="button">
                                    Thanh toán tất cả
                                </button>
                                <button onclick="proceedToCheckoutSelected()"
                                    ...
                                    id="checkout-selected-btn" type="button">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function renderSummary() {
                ...
                // Always show the checkout button, but change text based on selection
                    ...
                    if (isValid) {
                        ...
                        if (codeInput) {
                            ...
                            if (clearBtn && clearBtn.innerHTML === '×') clearBtn.style.display = '';
                                ...
                                newClearBtn.className = 'bg-gray-300 text-gray-600 px-3 py-2 rounded-r-lg hover:bg-gray-400 transition';
                                newClearBtn.onclick = () => clearDiscountCode();
                                codeInput.parentNode.appendChild(newClearBtn);
                            }
                        }
                    } else {
                        localStorage.removeItem('appliedDiscount');
                        discountEl.textContent = '-0₫';
                        discountEl.classList.remove('text-green-600');
                    }
                } else {
                    discountEl.textContent = '-0₫';
                    discountEl.classList.remove('text-green-600');
                ...
                totalEl.textContent = VND(Math.max(0, subtotal - discountAmount));
            }
            ...
            function applyDiscountCode() {
                ...
                fetch('/api/apply-coupon', {
                    ...
                    .then(data => {
                        ...
                        codeInput.value = data.coupon.code;
                        ...
                        renderSummary();
                        showNotification(`✅ Áp dụng mã giảm giá thành công! Giảm ${VND(data.discount_amount)}`, 'success');
                    })
                    .catch(() => {
                        codeInput.classList.add('border-red-500');
                        showNotification('❌ Có lỗi kết nối', 'error');
                    });
            }
            ...
            function initSelectionFeatures() {
                ...
                // Select all items by default for better UX
            ...
            window.proceedToCheckout = function() {
                ...
                const checkoutUrl = '{{ route('checkout.index') }}?selected=' + checked.join(',');
            ...
            document.getElementById('checkout-all-btn')?.addEventListener('click', function(e) {
                e.preventDefault();
                e.stopPropagation();
                proceedToCheckout();
            });
            
            document.getElementById('checkout-selected-btn')?.addEventListener('click', function(e) {
                e.preventDefault();
                e.stopPropagation();
