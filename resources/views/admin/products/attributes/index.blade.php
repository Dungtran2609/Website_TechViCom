...
@section('content')
    ...
    <form method="GET" action="{{ route('admin.products.attributes.index') }}"
        ...
        <input type="text" name="search" value="{{ request('search') }}" class="form-control w-auto"
            style="min-width:180px;max-width:220px;" placeholder="Tìm thuộc tính...">
        ...
        @if (request('search') || request('type') !== null)
