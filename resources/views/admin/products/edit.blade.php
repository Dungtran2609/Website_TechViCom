                            ...
                            <div class="tab-pane active" id="tab-general" role="tabpanel">
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control @error('long_description') is-invalid @enderror" id="long_description"
                                        name="long_description" rows="7">{{ old('long_description', $product->long_description) }}</textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('sku') is-invalid @enderror"
                                                name="sku" value="{{ old('sku', $simpleVariant?->sku) }}">
                                            @error('sku')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
...
$selected = old('attributes.' . $attribute->id);
                                                            if ($selected === null && isset($simpleVariant)) {
                                                                $selected = $simpleVariant->attributeValues->pluck('id')->contains($value->id) ? $value->id : null;
                                                            } @endphp
                                                        @selected($selected == $value->id)>{{ $value->value }}</option>
                                                @endforeach
                                            </select>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header">
                                                        <button class="accordion-button" type="button"
                                                            ...
                                                            data-bs-target="#collapse{{ $index }}">{{ $variant->attributeValues->pluck('value')->join(' / ') }}</button>
                                                    </h2>
                                                                ...
                                                                <div class="col-md-3 d-flex align-items-end">
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" type="checkbox"
                                                                            ...
                                                                            value="1" @checked(old('variants.' . $index . '.is_active', $variant->is_active))>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse${index}" class="accordion-collapse collapse show">
                        <div class="accordion-body">
                            ...
                            <div class="row">
                                ${attributeInputs}
                                <div class="col-md-6 mb-3"><label class="form-label">Giá bán <span class="text-danger">*</span></label><input type="number" class="form-control" name="variants[${index}][price]"></div>
                                <div class="col-md-6 mb-3"><label class="form-label">Giá khuyến mãi</label><input type="number" class="form-control" name="variants[${index}][sale_price]"></div>
                                <div class="col-md-6 mb-3"><label class="form-label">SKU <span class="text-danger">*</span></label><input type="text" class="form-control" name="variants[${index}][sku]"></div>
                                <div class="col-md-6 mb-3"><label class="form-label">Tồn kho <span class="text-danger">*</span></label><input type="number" class="form-control" name="variants[${index}][stock]"></div>
                            </div>
                            <hr><h6 class="mb-3">Thông tin vận chuyển</h6>
                            <div class="row">
            ...
            if (generateBtn) {
                generateBtn.addEventListener('click', () => {
                    ...
                    const accordion = variantsWrapper.querySelector('.accordion');

                    const existingCombos = Array.from(accordion.querySelectorAll('.accordion-item')).map(
                        item => {
                            return Array.from(item.querySelectorAll('input[name*="[attributes][]"]'))
                    ...
                    combinations.forEach((combo) => {
                        ...
                        accordion.insertAdjacentHTML('beforeend', variantHtml);
                        variantIndex++;
                    });
                });
            }
