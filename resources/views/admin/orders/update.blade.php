...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('admin.orders.show', $orderData['id']) }}" class="btn btn-info">
...
<form action="{{ route('admin.orders.updateOrders', $orderData['id']) }}" method="POST">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select name="status" class="form-select" @if (in_array($orderData['status'], ['cancelled', 'returned'])) disabled @endif>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    <label for="recipient_name" class="form-label fw-medium">Tên người nhận</label>
                ...
                <div class="col-md-4">
                    <label for="recipient_phone" class="form-label fw-medium">Số điện thoại</label>
                ...
                <div class="col-md-4">
                    <label for="recipient_address" class="form-label fw-medium">Địa chỉ</label>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h5 class="mb-0">Áp dụng Coupon</h5>
        </div>
        <div class="card-body">
            <div class="mb-3">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <label class="form-label fw-medium">Tổng sản phẩm</label>
    ...
    <div class="d-flex justify-content-end mb-5">
        ...
        <a href="{{ route('admin.orders.show', $orderData['id']) }}" class="btn btn-outline-secondary">
