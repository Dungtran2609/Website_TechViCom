            ...
            <div class="row">
                    ...
                    <div class="account-sidebar rounded-lg p-6 text-white mb-4">
                        <div class="text-center mb-6">
                            <div class="avatar-container mx-auto mb-3 position-relative">
                                @if (Auth::user()->image_profile)
                                    <img src="{{ asset('storage/' . Auth::user()->image_profile) }}" alt="Ảnh đại diện"
                                ...
                                <button type="button" class="btn btn-sm btn-light position-absolute bottom-0 end-0"
                                    onclick="document.getElementById('image_profile').click()" title="Đổi ảnh đại diện">
                        ...
                        <nav class="space-y-2">
                            <a href="{{ route('accounts.index') }}"
                                class="flex items-center p-3 rounded-lg hover:bg-white/10 text-white/80 hover:text-white transition">
                            ...
                            <a href="{{ route('accounts.profile') }}"
                                class="flex items-center p-3 rounded-lg bg-white/20 text-white">
                            ...
                            <a href="{{ route('accounts.change-password') }}"
                                class="flex items-center p-3 rounded-lg hover:bg-white/10 text-white/80 hover:text-white transition">
                ...
                <div class="col-lg-9">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <form method="POST" action="{{ route('accounts.update-profile') }}" class="account-form"
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="me-4">
                                        @if (Auth::user()->image_profile)
                                            <img src="{{ asset('storage/' . Auth::user()->image_profile) }}"
                                                alt="Ảnh đại diện hiện tại" class="rounded-circle border"
                                    ...
                                    <div class="flex-grow-1">
                                        <input type="file"
                                            ...
                                            id="image_profile" name="image_profile" accept="image/*" style="display: none;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('gender') is-invalid @enderror" id="gender"
                                            ...
                                            <option value="male"
                                                {{ old('gender', Auth::user()->gender) == 'male' ? 'selected' : '' }}>Nam
                                            </option>
                                            <option value="female"
                                                {{ old('gender', Auth::user()->gender) == 'female' ? 'selected' : '' }}>Nữ
                                            </option>
                                            <option value="other"
                                                {{ old('gender', Auth::user()->gender) == 'other' ? 'selected' : '' }}>Khác
                                            </option>
                                        </select>
                                        @error('gender')
                                            <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        reader.onload = function(e) {
                            ...
                            if (sidebarPreview) {
                                ...
                                if (sidebarPlaceholder) {
                                    ...
                                    newImg.style.objectFit = 'cover';
                                    sidebarPlaceholder.parentNode.replaceChild(newImg,
                                        sidebarPlaceholder);
                                }
                            }
                        };
